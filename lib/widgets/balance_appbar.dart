...
class _BalanceAppBarState extends ConsumerState<BalanceAppBar> {
  ...
  Widget build(BuildContext context) {
    ...
    return Theme(
      data: Theme.of(context).copyWith(textTheme: GoogleFonts.montserratTextTheme().apply(bodyColor: Colors.white)),
      child: Padding(
                      ...
                      child: Padding(
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Row(
                            ...
                            children: [
                              GestureDetector(
                                onTap: ref.read(appStateProvider.notifier).toggleBalanceVisibility,
                                child: SvgPicture.asset(
                                  appState.isBalanceVisible ? 'assets/svg/eye_icon.svg' : 'assets/svg/hide_icon.svg',
                                  width: 18,
                                  height: 20,
                                ),
                              ),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  FutureBuilder<BigInt>(
                                    future:
                                        ref.read(userProvider.notifier).getTokenBalance("0x04718f5a0fc34cc1af16a1cdee98ffb20c31f5cd61d6ab07201858f4287c938d"),
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  FutureBuilder<BigInt>(
                                    future:
                                        ref.read(userProvider.notifier).getTokenBalance("0x049d36570d4e46f48e99674bd3fcc84644ddd6b96f7c741b1562b82f9e004dc7"),
                                    builder: (context, snapshot) {
                                      if (snapshot.connectionState == ConnectionState.waiting) {
                                        return Transform.scale(scale: 0.2, child: const CircularProgressIndicator());
                                      }
                              ...
                              Column(
                                ...
                                children: [
                                  ...
                                  const SizedBox(width: 5),
                                  Text(appState.isBalanceVisible ? '0' : '********', style: const TextStyle(color: Colors.white, fontSize: 10)),
                                ],
                              ),
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      const SizedBox(width: 4.0),
                                      const Text('BROTHER', style: TextStyle(color: Colors.white, fontSize: 10)),
                                    ],
                                  ),
                                  const SizedBox(width: 5),
                                  Text(appState.isBalanceVisible ? '0' : '********', style: const TextStyle(color: Colors.white, fontSize: 10)),
